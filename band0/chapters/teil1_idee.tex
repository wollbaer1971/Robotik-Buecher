...
\begin{enumerate}
  \item Band 0: Linux, Docker und Entwicklungswerkzeuge.
  \item Band 1: Python für Robotik.
  \item Band 2: ROS2 mit Docker.
  \item Band 3: C++ für Robotik.
  \item Band 4: Mathematik für mobile Roboter.
  \item Band 5: Mathematik für Manipulatoren.
\end{enumerate}
\end{loesungBox}
...
ist und warum wir uns in Band 0 nicht auf Windows als Hauptumgebung stützen.
}
\kapitelstruktur
